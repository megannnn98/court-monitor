...
from extraction.models import EventEntityRole
...
from research.models import PersonResearchCriteria, ResearchRosfinmonitoring, ResearchSource
from research.service import PersonResearchDetails
