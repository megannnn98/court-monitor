...
Состояние на сегодня — 346 тестов, ruff + mypy чистые.
...
| `reprocess-all` + прогон корпуса | `HEAD` | Фикс `00d7ee0` жил в коде, но не в данных. 57 мусорных имён (`Жители Сочи`, `Власти Грузии`) и 32 недостающих реальных. После прогона с NER: фактов 672 → 736, имён 501 → 565, кандидатов 7 → 14 |
