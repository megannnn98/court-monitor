...
Этот файл описывает техническую сторону матчинга: нормализацию, score и
генерацию кандидатов. Операторский ручной сценарий с примерами решений описан
отдельно: [`manual-match-review.md`](manual-match-review.md).
